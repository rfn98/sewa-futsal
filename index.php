     ...
     <div id="myCarousel" class="carousel slide" data-ride="carousel">
         ...
         <div class="carousel-inner" role="listbox">
           <div class="item active">
             <img src="assets/futsal/1a.png" alt="Image">
           ...
           <div class="item">
             <img src="assets/futsal/2a.png" alt="Image">
             <div class="carousel-caption">
         ...
         <div class="item">
             <img src="assets/futsal/3a.png" alt="Image">
             <div class="carousel-caption">
         ...
         <div class="item">
             <img src="assets/futsal/4a.png" alt="Image">
             <div class="carousel-caption">
    ...
    <div class="container w3-content" style="max-width:1400px;margin-top:20px">
      ...
      <div class="w3-row">
        ...
        <!-- <div class="w3-col m3">
          ...
          <!-- Middle Column -->
        <div class="w3-col m12" style="margin-top:-10px;">
         <?php
    $batas = 3;
